...
const GHL_FIELDS = {
  ...
  // Detailed survey fields (v2)
  dcCriticalLoadCapacity: "EvwSm4G3tOQSjfTJ0xmJ",
  dcCapacityUtilisation: "ffezOwQmL44W88GFUx7D",
  dcExpansionCapability: "f8PXakRYCHAxhkmE2s8d",
  dcEbitdaMargin: "qafS0HWvH90MB570OLWM",
  dcPowerCost: "mND6RvqjDfdkmTU9ON5t",
  dcLongTermContracts: "TCP8cGKG2OpT34ucBxU9",
  dcTenantConcentration: "cWRkQCY4j3EX5pDi9STh",
  dcOwnershipType: "fy8Pcaj3Z5DsjcNVb1WI",
  dcRealEstateStatus: "4kUNOZjBgn9jXckoO7Ch",
  dcDebtStatus: "MKuGqJlP6Q5wIOpOsGWJ",
  dcMarketDemand: "l5HMtqb4hf5p9AIusv1E",
  dcManagementTeam: "ZdH6qDMbzrjGR8bECvEI",
  dcTransactionIntent: "VK82ppydbdA0Sp39VgXi",
  dcTimeline: "CS7k6C7Oxuw9EFmfvoLE",
  dcQualityScore: "DFppRsiArRX2Vkyh0NKw",
  dcReadinessScore: "GpYBswlnCcamKfKPnQiC",
  dcTotalScore: "hDqJIit1yFfELbVOtijG",
  dcTier: "UVBTxIxbEggwMz2KSJAM",
...
export const updateGHLContactSurvey = action({
  ...
  handler: async (ctx, args) => {
    ...
    // Note: GHL field IDs will be populated after running setupDetailedSurveyFields
    const customFields = [
      { id: GHL_FIELDS.dcCriticalLoadCapacity || "", field_value: args.survey.criticalLoadCapacity || "" },
      { id: GHL_FIELDS.dcCapacityUtilisation || "", field_value: args.survey.capacityUtilisation || "" },
      { id: GHL_FIELDS.dcExpansionCapability || "", field_value: args.survey.expansionCapability || "" },
      { id: GHL_FIELDS.dcEbitdaMargin || "", field_value: args.survey.ebitdaMargin || "" },
      { id: GHL_FIELDS.dcPowerCost || "", field_value: args.survey.powerCost || "" },
      { id: GHL_FIELDS.dcLongTermContracts || "", field_value: args.survey.longTermContracts || "" },
      { id: GHL_FIELDS.dcTenantConcentration || "", field_value: args.survey.tenantConcentration || "" },
      { id: GHL_FIELDS.dcOwnershipType || "", field_value: args.survey.ownershipType || "" },
      { id: GHL_FIELDS.dcRealEstateStatus || "", field_value: args.survey.realEstateStatus || "" },
      { id: GHL_FIELDS.dcDebtStatus || "", field_value: args.survey.debtStatus || "" },
      { id: GHL_FIELDS.dcMarketDemand || "", field_value: args.survey.marketDemand || "" },
      { id: GHL_FIELDS.dcManagementTeam || "", field_value: args.survey.managementTeam || "" },
      { id: GHL_FIELDS.dcTransactionIntent || "", field_value: args.survey.transactionIntent || "" },
      { id: GHL_FIELDS.dcTimeline || "", field_value: args.survey.timeline || "" },
      { id: GHL_FIELDS.dcQualityScore || "", field_value: String(args.detailedQualityScore ?? "") },
      { id: GHL_FIELDS.dcReadinessScore || "", field_value: String(args.detailedReadinessScore ?? "") },
      { id: GHL_FIELDS.dcTotalScore || "", field_value: String(args.detailedTotalScore ?? "") },
      { id: GHL_FIELDS.dcTier || "", field_value: args.detailedTier || "" },
    ].filter(f => f.id);
