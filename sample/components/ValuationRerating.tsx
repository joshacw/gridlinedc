...
const ValuationRerating: React.FC = () => {
  const annualRevenue = 8000000;
  const privateMultiplier = 2; 
  const publicMultiplier = 12;

  const privateValuation = annualRevenue * privateMultiplier;
  const publicValuation = annualRevenue * publicMultiplier;
  const uplift = publicValuation - privateValuation;
