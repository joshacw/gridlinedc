...
const OwnerPartnershipOptions: React.FC<OwnerPartnershipOptionsProps> = ({ onCtaClick }) => {
  ...
  return (
    <section id="partnership-options" className="py-24 bg-slate-50 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-outfit text-xxl font-bold text-dark-navy mb-4">Partnership &amp; Acquisition Options</h2>
          <p className="font-outfit text-gridline-gray max-w-3xl mx-auto text-sm italic">
            ...
            >
              ...
              <ul className="space-y-5 mb-6">
                {option.points.map((point, pIdx) => (
                  <li key={pIdx} className="flex gap-4 font-outfit text-xs text-gridline-gray leading-relaxed group/item">
              ...
              <p className="font-outfit text-xs text-slate-500 italic mb-8">{option.description}</p>
