        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {criteria.map((item, idx) => (
              <div key={idx} className="flex items-start gap-4 p-8 bg-white rounded-2xl border border-slate-200 shadow-sm hover:border-primary-blue/30 hover:shadow-md transition-all">
                <div className="p-4 bg-primary-blue/10 rounded-xl text-primary-blue shrink-0">
                  {item.icon}
                </div>
