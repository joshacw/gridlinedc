...
const WhyPartner: React.FC = () => {
  return (
    <section id="why-partner" className="py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Scale */}
          <div className="text-center p-10 rounded-card bg-slate-50 border border-slate-200 hover:border-primary-blue/30 transition-all">
