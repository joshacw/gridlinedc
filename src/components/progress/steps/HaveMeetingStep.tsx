  ...
  return (
    <div className="bg-[#0d1b33] rounded-lg p-6 sm:p-8">
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-white">Meeting Pending</h2>
      ...
      <div className="space-y-4">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="flex items-start gap-3 text-sm text-slate-300">
                <span className="w-5 h-5 rounded-full bg-[#4a9eff]/10 text-[#4a9eff] flex items-center justify-center flex-shrink-0 text-xs font-bold mt-0.5">
                  {i + 1}
                </span>
                {item}
              </li>
        ...
        <div className="bg-[#4a9eff]/5 border border-[#4a9eff]/20 rounded-lg p-5">
          <p className="text-sm text-slate-300">
            <span className="text-[#4a9eff] font-bold">What happens next:</span>{' '}
