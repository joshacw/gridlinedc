...
export default function PostMeetingStep({ stepNumber, label, description, detail }: Props) {
  return (
    <div className="bg-[#0d1b33] rounded-lg p-6 sm:p-8">
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[10px] uppercase tracking-widest text-[#4a9eff] font-bold">Step {stepNumber}</span>
          </div>
      ...
      <div className="mt-6 bg-[#4a9eff]/5 border border-[#4a9eff]/20 rounded-lg p-5">
        <div className="flex items-start gap-3">
          <svg className="w-5 h-5 text-[#4a9eff] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
